...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
		...
		public async Task SendStatistics()
		{
			...
			var value10 = _productService.TProductAvgByHamburger();
			await Clients.All.SendAsync("ReceiveProductAvgByHamburger", value10.ToString("0.00"));
			...
			var value14 = _moneyCaseService.TTotalMoney();
			await Clients.All.SendAsync("ReceiveTotalMoney", value14.ToString("0.00"));
		...
		public async Task SendProgress()
		{
			...
			var value6 = _productService.TProductAvgByHamburger();
			await Clients.All.SendAsync("ReceiveProductAvgByHamburger", value6);
